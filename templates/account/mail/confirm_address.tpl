...
<html lang="{MARKET.Lang}">
	<head>
		<meta charset="utf-8">
		<title>{LANG.Confirm your new email address at} "{LANG.Virtual City Market}"</title>
		<style>
	...
	<body>
		...
		<div class="margin">
			<h1>{LANG.Confirm your new email address at} "{LANG.Virtual City Market}"</h1>
			
			<p>{LANG.Dear} {USER.name} {USER.surname},<p>
			
			<p>{LANG.Please click on the provided link to confirm your new email address.}</p>
			
			<p>{LANG.If the below link does not work, you can paste the following url into your browser}:</p>
			<p><a href="http://{MARKET.Server}{MARKET.LWebDir}/account/confirm.html?code={CONFIRMATION_CODE}">http://{MARKET.Server}{MARKET.LWebDir}/account/confirm.html?code={CONFIRMATION_CODE}</a></p>
